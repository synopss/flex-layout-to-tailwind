...
describe('fxLayout directive migration', () => {
  ...
  it('should convert fxLayout="row"', () => {
    ...
    expect(convertTag(`<div fxLayout="row wrap-reverse inline">`)).toEqual(`<div class="inline-flex flex-row flex-wrap-reverse">`);
  ...
  it('should convert fxLayout="row-reverse"', () => {
    ...
    expect(convertTag(`<div fxLayout="row-reverse wrap inline">`)).toEqual(`<div class="inline-flex flex-row-reverse flex-wrap">`);
    expect(convertTag(`<div fxLayout="row-reverse wrap-reverse inline">`)).toEqual(`<div class="inline-flex flex-row-reverse flex-wrap-reverse">`);
    expect(convertTag(`<div fxLayout="row-reverse nowrap inline">`)).toEqual(`<div class="inline-flex flex-row-reverse flex-nowrap">`);
  })
  ...
  it('should convert fxLayout="column"', () => {
    ...
    expect(convertTag(`<div fxLayout="column wrap-reverse inline">`)).toEqual(`<div class="inline-flex flex-col flex-wrap-reverse">`)
    expect(convertTag(`<div fxLayout="column nowrap inline">`)).toEqual(`<div class="inline-flex flex-col flex-nowrap">`)
  })
  ...
  it('should convert fxLayout="column-reverse"', () => {
    ...
    expect(convertTag(`<div fxLayout="column-reverse wrap inline">`)).toEqual(`<div class="inline-flex flex-col-reverse flex-wrap">`)
    expect(convertTag(`<div fxLayout="column-reverse wrap-reverse inline">`)).toEqual(`<div class="inline-flex flex-col-reverse flex-wrap-reverse">`)
    expect(convertTag(`<div fxLayout="column-reverse nowrap inline">`)).toEqual(`<div class="inline-flex flex-col-reverse flex-nowrap">`)
  })
});
